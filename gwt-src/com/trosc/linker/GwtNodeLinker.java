...
public class GwtNodeLinker extends AbstractLinker {
    ...
    public ArtifactSet link(TreeLogger logger, LinkerContext context,
        ...
        out.print("var Fn = Function, $wnd = Fn('return this')();");
        out.newline();
        out.print("$wnd.alert = sys.printf;");
        out.newline();
        out.print("var $stats = function() { };");
        out.newline();
        out.print("var $sessionId = function() { };");
        out.newline();
        out.print("var $doc = {compatMode : 'CSS1Compat', documentMode : 10};");
        out.newline();
        out.print("if(typeof navigator == \"undefined\") { $wnd.navigator = { userAgent : 'webkit' }; }");
