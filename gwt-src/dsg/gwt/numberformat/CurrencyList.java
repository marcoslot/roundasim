...
public class CurrencyList implements Iterable<CurrencyData> {
  ...
  /**
   * Look a currency based on the ISO4217 currency code.
   * 
  ...
  /**
   * Look a currency name based on the ISO4217 currency code.
   * 
   * @param currencyCode ISO4217 currency code
  ...
  protected final native CurrencyData getEntry(String code) /*-{
    return this.@dsg.gwt.numberformat.CurrencyList::dataMap[':' + code];
  }-*/;
  ...
  protected final native String getNamesEntry(String code) /*-{
    return this.@dsg.gwt.numberformat.CurrencyList::namesMap[code];
  }-*/;
  ...
  protected native void loadCurrencyMap() /*-{
    this.@dsg.gwt.numberformat.CurrencyList::dataMap = {
        ":USD": [ "USD", "$", 2 ],
        ":EUR": [ "EUR", "€", 2 ],
        ":GBP": [ "GBP", "UK£", 2 ],
        ":JPY": [ "JPY", "¥", 0 ],
  ...
  protected native void loadNamesMap() /*-{
    this.@dsg.gwt.numberformat.CurrencyList::namesMap = {
        "USD": "US Dollar",
        "EUR": "Euro",
  ...
  private native void loadCurrencyKeys(ArrayList<String> keys) /*-{
    var map = this.@dsg.gwt.numberformat.CurrencyList::dataMap;
    for (var key in map) {
